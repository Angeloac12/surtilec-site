...
add_filter(
	...
	function ( $translated, $text, $domain ) {
		...
		static $map = array(
			...
			'This product is already in your quote request list.'            => 'Este producto ya está en tu lista de cotización.',
			'This product is already in your quote request list'             => 'Este producto ya está en tu lista de cotización',
			'The product was added to your quote request list.'              => 'El producto se añadió a tu lista de cotización.',
			'The product was added to your quote request list'               => 'El producto se añadió a tu lista de cotización',
